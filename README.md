[![Build Status](https://travis-ci.com/Harlan1997/travis-ci-tutorial-java.svg?branch=master)](https://travis-ci.com/Harlan1997/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/Harlan1997/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/Harlan1997/travis-ci-tutorial-java)
...
3. Fix the `README.md` badges (replacing in the URL `joaomlneto` with `Harlan1997`) and push the changes. This should trigger a build in Travis CI!
